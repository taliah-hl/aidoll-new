...
class AwsChatBot():
    def __init__(self, aws_access_key_id=None, aws_secret_access_key=None, aws_session_token=None, region_name='us-west-2'):
    ...
    def _chat_without_knowledge_base(self, msg:str, image_description:str):
        try:
